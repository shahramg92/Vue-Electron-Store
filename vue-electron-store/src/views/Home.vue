  ...
  <div class="bg-black text-white flex-1 ml-56 px-10">
    ...
    <div class="flex mb-10">
      <div class="w-1/2 mr-4 bg-grey-darkest rounded-lg flex px-8 py-6">
        <div class="flex-1">
          <div class="uppercase text-grey-light text0cs mb-1">
            Featured App
          </div>
          <h1 class="font-normal text-2xl mb-4">
            Get Focused, Fast
          </h1>
          <p class="text-grey-light text-xs leading-normal">
            OmniFocus transforms your to-do list. Click to read how.
          </p>
        </div>
      ...
      <div class="w-1/2 ml-4 bg-grey-darkest rounded-lg px-8 py-6">
        ...
        <p class="text-grey-light text-cs leading-normal mb-4">Dark is the new black.</p>
    ...
    <div class="flex flex-wrap mb-4">
      ...
      <div class="w-1/2 flex pl-6">
        ...
        <div class="pl-6 flex-1">
          ...
          <div class="mb-8">
            <span class="bg-white text-blue rounded-full px-3 py-1 text-xs font-bold">$39.99</span>
          </div>
          <div class="border-b border-grey-darker mb-10"></div>
        </div>
      </div>
      ...
      <div class="w-1/2 flex">
        ...
        <div class="pl-6 flex-1 pr-6">
          ...
          <div class="mb-8">
            <span class="bg-white text-blue rounded-full px-3 py-1 text-xs font-bold uppercase">Get</span>
          </div>
        </div>
      </div>
      ...
      <div class="w-1/2 flex pl-6">
        ...
        <div class="pl-6 flex-1">
          ...
          <div class="text-grey text-xs mb-6">Calender and Reminders</div>
          <div class="mb-8">
            <span class="bg-white text-blue rounded-full px-3 py-1 text-xs font-bold">$69.99</span>
          </div>
        </div>
      </div>
